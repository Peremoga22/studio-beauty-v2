...
namespace webStudioBlazor.Data.Migrations
{
    ...
    [Migration("20260514184738_AddTreatmentHistories")]
    partial class AddTreatmentHistories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webStudioBlazor.EntityModels.GiftCertificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GiftCertificates", (string)null);
                });
            ...
            modelBuilder.Entity("webStudioBlazor.EntityModels.OrderItem", b =>
                {
                    ...
                    b.Property<bool>("IsShownInOrder")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("webStudioBlazor.EntityModels.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webStudioBlazor.EntityModels.TreatmentHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SkinAfterDescription")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");

                    b.Property<string>("SkinBeforeDescription")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
                    ...
                    b.HasIndex("ClientId", "VisitDate");

                    b.ToTable("TreatmentHistories", (string)null);
                });

            modelBuilder.Entity("webStudioBlazor.EntityModels.TreatmentPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TreatmentPhotos", (string)null);
                });
            ...
            modelBuilder.Entity("webStudioBlazor.EntityModels.Appointment", b =>
                {
                    ...
                    b.HasOne("webStudioBlazor.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("webStudioBlazor.EntityModels.TreatmentPhoto", b =>
                {
                    b.HasOne("webStudioBlazor.EntityModels.TreatmentHistory", "TreatmentHistory")
                        .WithMany("Photos")
